...
namespace WistBot.Core.Actions
{
    public class DeleteDescriptionCallbackAction : IBotAction
    {
        ...
        public DeleteDescriptionCallbackAction(ITelegramBotClient bot, ItemsService wishListItemsService, LocalizationService localizationService, UserStateManager stateManager)
        {
            _bot = bot;
