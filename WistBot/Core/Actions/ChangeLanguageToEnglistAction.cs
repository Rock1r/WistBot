...
{
    public class ChangeLanguageToEnglistAction : IBotAction
    {
        private readonly ITelegramBotClient _bot;
        private readonly UsersService _usersService;
        private readonly LocalizationService _localization;

        public string Command => Button.English;

        public ChangeLanguageToEnglistAction(ITelegramBotClient bot, UsersService usersService, LocalizationService localizationService)
        {
            _bot = bot;
        ...
        public async Task ExecuteMessage(Message message, CancellationToken token)
        {
            ...
            try
            {
                ...
                await _usersService.SetLanguage(user.Id, LanguageCodes.English);
