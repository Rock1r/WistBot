...
namespace WistBot.Migrations
{
    ...
    [Migration("20250107110329_Initial")]
            ...
            modelBuilder.Entity("WistBot.Data.Models.WishListItemEntity", b =>
                {
                    ...
                    b.Property<long?>("PerformerNameTelegramId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("PerformerNameTelegramId");
            ...
            modelBuilder.Entity("WistBot.Data.Models.WishListItemEntity", b =>
                {
                    ...
                    b.HasOne("WistBot.Data.Models.UserEntity", "PerformerName")
                        .WithMany()
                        .HasForeignKey("PerformerNameTelegramId");
